...
const BUILD_TIME="2026-05-14T17:00:00Z";
            ...
            {dayTasks.length===0?(<div style={{textAlign:"center",paddingTop:20,color:th.text6,fontSize:11}}>—</div>):(
              dayTasks.map(t=>(<div key={t.id} onClick={()=>onNavigate(t.catId)} style={{marginBottom:5,padding:"5px 8px",borderRadius:7,background:t.catColor.light,border:`1px solid ${t.catColor.accent}33`,cursor:"pointer",transition:"opacity 0.15s"}}
                ...
                <div style={{display:"flex",alignItems:"flex-start",gap:4}}>
                  {t.taskKind&&t.taskKind!=="tarea"&&(t.taskKind==="reminder"||t.taskKind==="reunion"
                    ?<span style={{fontSize:9,flexShrink:0,color:"#aaa",fontStyle:"italic",whiteSpace:"nowrap"}}>{TASK_KIND[t.taskKind]?.label}</span>
                    :<span style={{fontSize:9,padding:"1px 6px",borderRadius:99,fontWeight:700,flexShrink:0,background:TASK_KIND[t.taskKind]?.bg,color:TASK_KIND[t.taskKind]?.color,border:`1px solid ${TASK_KIND[t.taskKind]?.color}44`}}>{TASK_KIND[t.taskKind]?.label}</span>
                  )}
...
// ── Datos restaurar desde informe PDF 2026-03-25 ─────────────
const FIRMES_RESTORE_DATA = {
  reportDate: "2026-03-25",
  completed: [
    {text:"Análisis próximos destinos susceptibles a BOS - cargas a granel",priority:"alta",completedAt:"2026-03-25",labels:[{id:"lb-f1",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Ajustar BBDD Firmes con los datos de todos los clientes",priority:"alta",completedAt:"2026-03-25",labels:[{id:"lb-f2",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"KPIs FIRMES: Añadir detalle estado general cajas",priority:"baja",completedAt:"2026-03-25",labels:[{id:"lb-f3",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Seguimiento cajas en espera semanal",priority:"media",completedAt:"2026-03-23",labels:[{id:"lb-f4",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"KPIs FIRMES: Añadir tiempo medio al informe",priority:"alta",completedAt:"2026-03-17",labels:[{id:"lb-f5",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Cambio Incoterm: ASOS a DDP + quitar manipulado cambio de caja",priority:"alta",completedAt:"2026-03-10",labels:[{id:"lb-f6",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Destinos de regular a irregular: COSTA_RICA, GUATEMALA, LAOS, EGIPTO",priority:"baja",completedAt:"2026-03-10",labels:[{id:"lb-f7",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Enviar mails automáticos - Microsoft Lists Planificación FIRMES",priority:"media",completedAt:"2026-03-09",labels:[{id:"lb-f8",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Definición objetivos 2026 comunes Export-Logística-Firmes",priority:"alta",completedAt:"2026-03-08",labels:[{id:"lb-f9",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Microsoft Lists en marcha Supply - Firmes para mejor coordinación",priority:"media",completedAt:"2026-03-08",labels:[{id:"lb-f10",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Definición Informe mensual seguimiento proyecto FIRMES",priority:"media",completedAt:"2026-03-07",labels:[{id:"lb-f11",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Pruebas previsiones transportistas con Israel exitosas - posible escalado a BOS",priority:"alta",completedAt:"2026-03-07",labels:[{id:"lb-f12",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
  ],
  active: [
    {text:"Conectar Microsoft Lists con PowerBi",priority:"media",status:"en-curso",checklist:[{id:"ca1",text:"Completado",done:true,state:"Completada"},{id:"ca2",text:"Pendiente A",done:false,state:"Pendiente"},{id:"ca3",text:"Pendiente B",done:false,state:"Pendiente"}],labels:[{id:"lb-fa1",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Análisis migración Israel DXC + BOS",priority:"media",status:"en-curso",checklist:[{id:"ca4",text:"Completado",done:true,state:"Completada"},{id:"ca5",text:"Pendiente A",done:false,state:"Pendiente"},{id:"ca6",text:"Pendiente B",done:false,state:"Pendiente"}],labels:[{id:"lb-fa2",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Slots de carga con recogida irregular",priority:"media",status:"en-curso",checklist:[{id:"ca7",text:"Completado",done:true,state:"Completada"},{id:"ca8",text:"Pendiente A",done:false,state:"Pendiente"},{id:"ca9",text:"Pendiente B",done:false,state:"Pendiente"},{id:"ca10",text:"Pendiente C",done:false,state:"Pendiente"}],labels:[{id:"lb-fa3",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"KPIs FIRMES: Eliminar cajas BTS",priority:"baja",status:"en-curso",deadline:"2026-03-27",checklist:[],labels:[{id:"lb-fa4",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
  ],
  blocked: [
    {text:"Migración Kazajistán BOS",priority:"media",status:"bloqueado",blockReason:"Previsiones no válidas por pedidos en 06 (crédito insuficiente)",labels:[{id:"lb-fb1",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Crear proceso deshacer cajas",priority:"alta",status:"bloqueado",deadline:"2026-04-10",blockReason:"El flujo no está definido y no hay muchas posibilidades a nivel de sistema para recuperar el stock",labels:[{id:"lb-fb2",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
  ],
  backlog: [
    {text:"Análisis reparto + manipulado de ASOS en NEXE",priority:"alta",status:"backlog",labels:[{id:"lb-fc1",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Identificar los clientes con cierre bisemanal y modificar operativa",priority:"media",status:"backlog",deadline:"2026-04-23",labels:[{id:"lb-fc2",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Análisis próximos destinos a BOS - cargas a granel",priority:"alta",status:"backlog",labels:[{id:"lb-fc3",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
    {text:"Revisión de clientes bajo volumen con minimos posible migracion a irregulares",priority:"baja",status:"backlog",deadline:"2026-04-24",labels:[{id:"lb-fc4",text:"Estandarización FIRMES",color:"#2E5FA3"}]},
  ]
};
...
function AyudaTab({th,dark}){
  ...
  const modules=[
    {id:"categorias",icon:"📂",title:"Categorías",color:"#4ECDC4",
      ...
      items:[
        {k:"Tipos",v:"tasks (tareas estándar) · meeting (121 Manager) · meeting121eq (121 Equipo) · personal (oculta en informes)"},
    ...
    {id:"tareas",icon:"📋",title:"Tareas",color:"#2E5FA3",
      ...
      items:[
        ...
        {k:"Filtrar etiqueta",v:"Selector de etiquetas en la cabecera de la categoría para ver solo tareas de un proyecto."},
      ]},
    {id:"reminders",icon:"⏰",title:"Reminders",color:"#FF9F43",
      summary:"Tipo de tarea pensado para recordatorios puntuales. Excluidos del informe ejecutivo.",
      items:[
    ...
    {id:"cal-tareas",icon:"📌",title:"Calendario Tareas",color:"#FF6B6B",
      ...
      items:[
        ...
        {k:"Tipo en cards",v:"Reunión y Reminder aparecen en cursiva gris. Seguimiento con badge de color."},
      ]},
    {id:"meeting",icon:"🎙️",title:"121 Manager",color:"#C3A6FF",
      ...
      items:[
        {k:"Crear reunión",v:"Botón '＋ Nueva reunión'. Los puntos pendientes de la última activa se arrastran automáticamente."},
    ...
    {id:"meeting121eq",icon:"🗓️",title:"121 Equipo",color:"#FD79A8",
      ...
      items:[
        ...
        {k:"Herencia",v:"Los puntos pendientes de la última reunión con ese colaborador se arrastran a la nueva."},
    ...
    {id:"historial",icon:"✓",title:"Historial",color:"#6BCB77",
      ...
      items:[
        ...
        {k:"Export",v:"Excel + Dashboard HTML con gráficos de distribución y timeline mensual."},
      ]},
    {id:"informe",icon:"📄",title:"Informe Ejecutivo",color:"#1A3A6E",
      summary:"Informe HTML/PDF por proyecto. Se genera desde Historial → Por proyecto.",
      items:[
        {k:"Seleccionar proyectos",v:"Las etiquetas de las tareas actúan como proyectos. Selecciona una o varias."},
        {k:"Periodo",v:"Opcional. Filtra las tareas completadas por fechas."},
    ...
    {id:"kpis",icon:"📊",title:"KPIs",color:"#E07B39",
      ...
      items:[
        {k:"Proyectos",v:"Pestaña por proyecto. Estandarización FIRMES viene precargado. El resto se añade desde etiquetas."},
        ...
        {k:"Gráfico",v:"Barras o línea. Botón 'Ver tabla/Ver gráfico' para alternar."},
    ...
    {id:"backup",icon:"💾",title:"Backup y datos",color:"#A0A0B8",
      summary:"Todos los datos se guardan en localStorage del navegador. Haz backups periódicos.",
      items:[
        ...
        {k:"Dónde se guarda",v:"localStorage del navegador. Si limpias caché o cambias de navegador, los datos se pierden."},
      ]},
  ];
  ...
  return(<div style={{padding:"20px 0"}}>
    <div style={{background:dark?"#0D1E35":"#EEF3FB",borderRadius:16,padding:"20px 24px",marginBottom:28,border:`1px solid ${dark?"#1A3A6E55":"#C0D0E8"}`}}>
      ...
      <p style={{margin:"0 0 10px",color:th.text3,fontSize:13,lineHeight:1.7}}>App de gestión diseñada para trackear tareas por categoría, hacer seguimiento de reuniones 1:1 con manager y equipo, visualizar métricas de proyecto y generar informes ejecutivos.</p>
      <div style={{display:"flex",flexWrap:"wrap",gap:8}}>
        {[["📂","Categorías personalizables"],["📋","Tareas con checklist y etiquetas"],["🎙️","Reuniones 1:1 con herencia"],["📊","KPIs con gráficos"],["📄","Informe ejecutivo PDF"],["💾","Backup JSON local"]].map(([ic,lb])=>(
          <span key={lb} style={{display:"flex",alignItems:"center",gap:5,padding:"4px 10px",borderRadius:99,background:dark?"#1A2535":"#fff",border:`1px solid ${dark?"#2A3A55":"#D0DCF0"}`,fontSize:11,color:th.text4,fontWeight:600}}><span>{ic}</span>{lb}</span>
        ))}
      </div>
    </div>
    ...
    <div style={{marginTop:24,padding:"12px 16px",borderRadius:10,background:th.surface2,border:`1px solid ${th.border2}`,display:"flex",alignItems:"center",gap:10}}>
      ...
      <span style={{fontSize:11.5,color:th.text4,lineHeight:1.6}}>Los datos se guardan automáticamente en el navegador. <strong style={{color:th.text3}}>Haz backup periódico</strong> con el botón ⬇ Backup de la cabecera para no perder nada si limpias la caché.</span>
    </div>
  </div>);
}
...
export default function App(){
  ...
  // ── Importar informe PDF via API Claude ───────────────────────
  const [importingPdf, setImportingPdf] = useState(false);

  const importFromPdf = (e) => {
    const file = e.target.files[0];
    e.target.value = "";
    if(!file) return;

    // Pedir API key si no está guardada
    let apiKey = localStorage.getItem("mdt_apikey") || "";
    if(!apiKey) {
      apiKey = window.prompt("Introduce tu API key de Anthropic:\n(empieza por sk-ant-)");
      if(!apiKey) return;
      apiKey = apiKey.trim().replace(/\s+/g,"");
      if(!apiKey.startsWith("sk-ant-")) {
        alert("La key no parece válida — debe empezar por sk-ant-");
        return;
      }
      localStorage.setItem("mdt_apikey", apiKey);
    }
    const apiKey2 = apiKey.trim().replace(/\s+/g,"");
    ...
    reader.onload = async (ev) => {
      try {
        ...
        const response = await fetch("/api/import-pdf", {
          ...
          body: JSON.stringify({ pdfBase64: base64, apiKey: apiKey2 })
        });

        if (!response.ok) {
          const err = await response.json().catch(()=>({}));
          if(response.status===401) localStorage.removeItem("mdt_apikey");
          throw new Error((err?.error?.message || `Error ${response.status}`) + (err?.keyInfo ? `\nKey recibida: ${err.keyInfo.length} chars, empieza: "${err.keyInfo.first10}"` : ""));
        }
        ...
        const projectName = parsed.projectName || file.name.replace(".pdf","");
        const labelColor = "#2E5FA3";

        const mkT = (t) => ({
          id:genId(), text:t.text.trim(), done:t.status==="completada", taskKind:"tarea",
          priority:t.priority||"media",
          status:t.status==="completada"?"backlog":(t.status||"backlog"),
          blockReason:t.blockReason||"",
          createdAt:t.completedAt||today(),
          deadline:t.deadline||null,
          completedAt:t.status==="completada"?(t.completedAt||today()):null,
          recurrence:null, jiraUrl:"", description:"",
          checklist:[], contacts:[],
          labels:[{id:genId(), text:projectName, color:labelColor}],
          owner:"",
        });

        const allTasks = (parsed.tasks||[]).map(mkT);
        if(!allTasks.length){alert("No se encontraron tareas en el PDF.");return;}

        const done=allTasks.filter(t=>t.done).length;
        const active=allTasks.filter(t=>!t.done&&(t.status==="en-curso"||t.status==="escalado")).length;
        const blocked=allTasks.filter(t=>t.status==="bloqueado").length;
        const backlog=allTasks.filter(t=>!t.done&&t.status==="backlog").length;

        if(!window.confirm(`¿Importar "${projectName}"?\n\n• ${done} completadas\n• ${active} en curso\n• ${blocked} bloqueadas\n• ${backlog} backlog\n\nTotal: ${allTasks.length} tareas.`)) return;

        setLabelBank(prev=>prev.find(l=>l.text===projectName)?prev:[...prev,{id:genId(),text:projectName,color:labelColor}]);
        setCatsP(prev=>{
          const existing=prev.find(c=>c.name===projectName);
          if(existing){
            const existingTexts=new Set(existing.tasks.map(t=>t.text));
            const newTasks=allTasks.filter(t=>!existingTexts.has(t.text));
            return prev.map(c=>c.id===existing.id?{...c,tasks:[...c.tasks,...newTasks]}:c);
          }
          return [...prev,{id:genId(),name:projectName,icon:"🎯",colorIdx:0,type:"tasks",tasks:allTasks}];
        });
        alert(`✅ "${projectName}" importado\n• ${done} completadas · ${active} en curso · ${blocked} bloqueadas · ${backlog} backlog`);
      } catch(err) {
  ...
  const doAutoBackup = (cats) => {
    try {
      const data = {version:1, exportedAt:new Date().toISOString(), cats, auto:true};
      const json = JSON.stringify(data);
      // Guardar en localStorage como backup de emergencia
      localStorage.setItem("mdt_autobackup", json);
      localStorage.setItem("mdt_autobackup_ts", new Date().toISOString());
      // Descargar fichero
      const blob = new Blob([json], {type:"application/json"});
      const url = URL.createObjectURL(blob);
      const a = document.createElement("a");
      a.href = url;
      a.download = `mardetareas_autobackup_${today()}.json`;
      document.body.appendChild(a); a.click(); document.body.removeChild(a);
      URL.revokeObjectURL(url);
    } catch(err) {
      console.warn("Autobackup error:", err);
    }
  };

  // Backup al cerrar pestaña (solo localStorage, no descarga — el navegador bloquea descargas en beforeunload)
  useEffect(()=>{
    const handler = () => {
      try {
        const data = {version:1, exportedAt:new Date().toISOString(), cats:catsRef.current, auto:true};
        localStorage.setItem("mdt_autobackup", JSON.stringify(data));
        localStorage.setItem("mdt_autobackup_ts", new Date().toISOString());
      } catch{}
    };
  ...
  // Backup periódico cada 30 minutos (descarga fichero)
  useEffect(()=>{
    const interval = setInterval(()=>doAutoBackup(catsRef.current), 30*60*1000);
    ...
    <div style={{minHeight:"100vh",background:th.bg,fontFamily:"'DM Sans','Segoe UI',system-ui,sans-serif",display:"flex",flexDirection:"column",transition:"background 0.2s"}}>
      ...
      <div style={{padding:"12px 16px",borderBottom:`1px solid ${th.border3}`,display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,background:th.sidebar,boxShadow:dark?"none":"0 1px 6px #0001",position:"sticky",top:0,zIndex:100}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap"}}>
          ...
          <span style={{color:"#fff",fontSize:10,fontWeight:700,background:"#6633CC",padding:"3px 9px",borderRadius:6,flexShrink:0,whiteSpace:"nowrap"}} title="Último deploy">🕐 v1.20 · {BUILD_TIME.slice(5,10)} {BUILD_TIME.slice(11,16)}</span>
          <label title={importingPdf?"Procesando PDF...":"Importar informe PDF (requiere API key de Anthropic)"}
            style={{padding:"5px 9px",borderRadius:99,border:"1px solid #9966FF66",background:dark?"#1A1228":"#F5F0FF",color:importingPdf?"#999":"#9966FF",fontSize:11,cursor:importingPdf?"default":"pointer",fontWeight:700,whiteSpace:"nowrap",opacity:importingPdf?0.6:1}}>
            {importingPdf?"⏳ Leyendo PDF...":"📄 Importar PDF"}
            <input type="file" accept=".pdf" style={{display:"none"}} onChange={importFromPdf} disabled={importingPdf}/>
          </label>
          {localStorage.getItem("mdt_apikey")&&<span onClick={()=>{if(window.confirm("¿Borrar la API key guardada?"))localStorage.removeItem("mdt_apikey");}} style={{fontSize:9,color:"#9966FF",cursor:"pointer",background:"#9966FF22",padding:"2px 6px",borderRadius:99,whiteSpace:"nowrap"}} title="API key guardada · click para borrar">🔑 key ✓</span>}
          <button onClick={()=>{doAutoBackup(cats);}} style={{padding:"5px 9px",borderRadius:99,border:`1px solid ${th.border}`,background:"transparent",color:"#6BCB77",fontSize:11,cursor:"pointer",fontWeight:700}}>⬇ Backup</button>
          <label style={{padding:"5px 9px",borderRadius:99,border:`1px solid ${th.border}`,background:"transparent",color:"#74B9FF",fontSize:11,cursor:"pointer",fontWeight:700}} title="Restaurar desde backup JSON">⬆ Restaurar<input type="file" accept=".json" style={{display:"none"}} onChange={e=>{const file=e.target.files[0];if(!file)return;const reader=new FileReader();reader.onload=ev=>{try{const data=JSON.parse(ev.target.result);if(!data.cats)throw new Error();if(window.confirm(`¿Restaurar backup del ${new Date(data.exportedAt).toLocaleDateString("es-ES")}?${data.auto?" (autobackup)":""}`)){setCatsP(data.cats);window.location.reload();}}catch{alert("Archivo no válido.");}};reader.readAsText(file);e.target.value="";}} /></label>
          {localStorage.getItem("mdt_autobackup_ts")&&<span style={{fontSize:9,color:th.text5,whiteSpace:"nowrap"}} title={`Último autobackup: ${new Date(localStorage.getItem("mdt_autobackup_ts")||"").toLocaleString("es-ES")}\nSe guarda en localStorage al cerrar y se descarga cada 30 min`}>🔄 {new Date(localStorage.getItem("mdt_autobackup_ts")||"").toLocaleTimeString("es-ES",{hour:"2-digit",minute:"2-digit"})}</span>}
