...
function exportHistorial(doneTasks){
  downloadCSV(`historial_${today()}.csv`,[["Tarea","Categoría","Fecha Inicio","Fecha Fin","Deadline","Prioridad"],...doneTasks.map(t=>[t.text||"",t.catName||"",t.createdAt||"",t.completedAt||"",t.deadline||"",t.priority||""])]);
}
    ...
    <div style={{minHeight:"100vh",background:th.bg,fontFamily:"'DM Sans','Segoe UI',system-ui,sans-serif",display:"flex",flexDirection:"column",transition:"background 0.2s"}}>
      ...
      <div style={{padding:"12px 16px",borderBottom:`1px solid ${th.border3}`,display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,background:th.sidebar,boxShadow:dark?"none":"0 1px 6px #0001",position:"sticky",top:0,zIndex:100}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap"}}>
          ...
          <span style={{color:th.text4,fontSize:10,fontWeight:600,background:th.border2,padding:"2px 8px",borderRadius:6,border:`1px solid ${th.border}`}} title="Último deploy">🕐 {BUILD_TIME.slice(0,10)} {BUILD_TIME.slice(11,16)}</span>
        ...
        <div style={{flex:1,overflowY:"auto",padding:"18px 20px"}}>
          ...
          {tab==="history"&&(<div>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:5,flexWrap:"wrap",gap:10}}>
              <div><h2 style={{color:th.text,fontSize:18,fontWeight:800,margin:0}}>Historial</h2><p style={{color:th.text5,fontSize:11,margin:"3px 0 0"}}>{doneTasks.length} finalizadas</p></div>
